...
Response.AddHeader "Content-Disposition", "attachment; filename = 020data.xls"
%>
<html>
<head>
</head>
...
'myconn1_Xsl="Provider=Microsoft.Jet.OLEDB.4.0;Data Source=c:\inetpub\excel\gz\file\book2.xls;Extended Properties=Excel 8.0"
myconn1_Xsl="Provider=Microsoft.ACE.OLEDB.12.0;Data Source=c:\inetpub\excel\gz\file\book2.xls;Extended Properties=Excel 12.0"
xlsconn1.open myconn1_Xsl


sql = "select '广州' as 分校,学员uid,学员名称,班级名称,课次,课程日期,上课时间,下课时间,教师名称,教学点,教室,母亲电话,父亲电话 from [Sheet0$]   where 班级名称 not like '短期班%' and 班级名称 not like '活动类%' and 班级名称 not like 'X试类%' and 班级名称 not like '诊X类%' and 班级名称 not like '%高中%' and 班级名称 not like '%双X%' and 班级名称 not like '%小学五年级X%' and 班级名称 not like '%兴趣小组%' and 班级名称 not like '%此班取消%' order by 教师名称 "
