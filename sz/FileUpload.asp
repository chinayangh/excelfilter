...
<form id="uploadForm" action="file.asp" method="post"   enctype="multipart/form-data">
  <table border="0" cellspacing="1" class="fu_list">
    ...
    <tbody>
      ...
      <tr>
        <td colspan="2" align="center" id="idMsg"><input type="button" value="开始上传" id="idBtnupload" class="btn" disabled="disabled" />
          &nbsp;&nbsp;&nbsp;
          
          <input type="button" value="开始筛选" id="idBtndel123"  title="先上传再筛选" class="btn" onclick="window.location.href = 'update.asp'" />

        </td>
        
      </tr>
      <tr><td colspan="2" style="color: red">如上传数据量比较大，导入时候请耐心等待页面返回结果，切忌反复刷新页面</td></tr>
    </tbody>
  </table>
<div style="margin-top:-18%;float:right"><a href="logout.asp">注销</a></div>
</form>
...
$("idBtnupload").onclick = function(){
	...
	$("idMsg").innerHTML = "正在上传文件中，请稍候……<br />有可能因为网络问题，出现程序长时间无响应，请点击“<a href='?'><font color='red'>取消</font></a>”重新上传文件";
