...
sql = "select '南京' as 分校,学员X,学员名称,班级名称,课次,课程日期,上课时间,下课时间,教师名称,教学点,教室,母亲X,父亲X from [Sheet0$] where 班级名称 not like 'X班%' and 班级名称 not like 'X类%' and 班级名称 not like 'X类%' and 班级名称 not like 'X类%' and 班级名称 not like '%高中%' and 班级名称 not like '%双X%' and 班级名称 not like '%X班%' and 班级名称 not like '%X班%'"
