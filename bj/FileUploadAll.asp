...
<form id="uploadForm" action="file.asp" method="post"   enctype="multipart/form-data">
  <table border="0" cellspacing="1" class="fu_list">
    <thead>
      <tr>
        <td colspan="2" nowrap="nowrap"><font size="5" color="red">北京010</font><b>文件上传</b></td>
    ...
    <tbody>
      <tr>
        <td align="right" width="10%" style="line-height:35px;">添加文件：</td>
        <td><a href="javascript:void(0);" class="files" id="idFile"></a> <img id="idProcess" style="display:none;" src="img/loading.gif" />
	 <td colspan="2" width="280px"><table border="0" cellspacing="0">
            <thead>
              <tr>
                <td>文件路径</td>
                <td width="100"></td>
			...
			<td colspan="2" align="center" id="idMsg" width="120px"><input type="button" value="开始上传" class="btn" id="idBtnupload"  disabled="disabled" />
          &nbsp;&nbsp;&nbsp;
          
          <input type="button" value="开始筛选" id="idBtndel123"  title="先上传再筛选"  class="btn" onclick="window.location.href = 'update2.asp'" />
			</td>
		</td>
	    </tr>
...
var fu = new FileUpload("uploadForm", "idFile", { Limit: 0, ExtIn: ["xls"], RanName: true,
...
$("idBtnupload").onclick = function(){
	...
	$("idMsg").innerHTML = "正在上传，请稍候……<br />如因网络问题程序无响应，请点击“<a href='?'><font color='red'>取消</font></a>”重新上传";
