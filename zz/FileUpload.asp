    ...
    <tbody>
      ...
      <tr>
        <td colspan="2" align="center" id="idMsg"><input type="button" value="开始上传" id="idBtnupload"  disabled="disabled" />
          ...
          <input type="button" value="开始筛选" id="idBtndel123"  title="先上传再筛选"  onclick="window.location.href = 'update2.asp'" />

	  &nbsp;&nbsp;&nbsp;
          
          <input type="button" value="格式转换" id="idBtndel456"  title="先筛选再转换"  onclick="window.location.href = 'pyconver.py'" />
