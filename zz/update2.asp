...
sql = "select '郑州' as 分校,学员X,学员名称,班级名称,课次,课程日期,上课时间,下课时间,教师名称,教学点,教室,母亲X,父亲X from [Sheet0$]   where 班级名称 not like '短X班%' and 班级名称 not like '活X类%' and 班级名称 not like 'X类%' and 班级名称 not like 'X类%' and 班级名称 not like '%高中%' and 班级名称 not like '%双X%'  and (上课时间 like '%10:30%' or 上课时间 like '%08:00%' or 上课时间 like '%08:30%' or 上课时间 like '%12:00%' or 上课时间 like '%13:20%' or 上课时间 like '%14:50%' or 上课时间 like '%15:50%' or 上课时间 like '%18:00%' or 上课时间 like '%18:30%')  order by 教师名称 "
