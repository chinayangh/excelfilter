...
sql = "select '广州' as 分校,学员X,学员名称,班级名称,课次,课程日期,上课时间,下课时间,教师名称,count(教师名称) as num,教学点,教室,母亲X,父亲X from [Sheet0$]   where 班级名称 not like '短期X%' and 班级名称 not like '活X类%' and 班级名称 not like 'X类%' and 班级名称 not like 'X类%' and 班级名称 not like '%高中%' and 班级名称 not like '%X师%' and 班级名称 not like '%X语文%' and 班级名称 not like '%兴趣X%'  order by 教师名称 "
